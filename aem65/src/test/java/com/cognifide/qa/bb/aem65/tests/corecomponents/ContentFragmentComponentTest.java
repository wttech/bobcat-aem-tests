...
public class ContentFragmentComponentTest extends AbstractAemAuthorTest {
  ...
  private static final String TEST_PAGE_PATH = "/content/core-components-examples/library/content-fragment-component-test-page";
  ...
  public void configureAsset() throws ActionException {
    controller.execute(AemActions.CONFIGURE_COMPONENT,
        new ConfigureComponentData("container", "Content Fragment (v1)", 0,
  ...
  public void configureDisplayModeForSingleElement() throws ActionException {
    controller.execute(AemActions.CONFIGURE_COMPONENT,
        new ConfigureComponentData("container", "Content Fragment (v1)", 1,
            new ResourceFileLocation(
